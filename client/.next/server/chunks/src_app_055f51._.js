...
const getCompanyId = async (id)=>{
    return await fetch(`${("TURBOPACK compile-time value", "https://europe-west1-wellbe-book-dev.cloudfunctions.net/")}getCompany/${id}`).then((response)=>{
        if (!response.ok) {
...
function AppointmentsList({ status }) {
    const {} = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$entities$292f$appointment$2f$queries$2f$useAppointments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppointments"]();
    return /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$future$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_components$2f$Layout$2f$FlexColumn$2f$index$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        rowGap: "1rem",
...
//# sourceMappingURL=src_app_055f51._.js.map