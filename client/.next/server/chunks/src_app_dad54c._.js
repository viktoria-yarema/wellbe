...
function AppointmentCard({ card }) {
    const { companyName, serviceName, status, staff, appointmentDate, companyImg, id } = card;
    ...
    const img = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$_global$2f$getStorageDownloadLink$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](companyImg);
...
const getAppointments = async ({ pageParam = null })=>{
    ...
    // }
    return await fetch(`${("TURBOPACK compile-time value", "https://europe-west1-wellbe-book-dev.cloudfunctions.net/")}getAppointments`).then((response)=>{
        if (!response.ok) {
...
function AppointmentsList() {
    const { data: appointments } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"]({
        queryKey: [
            "appointments"
        ],
...
//# sourceMappingURL=src_app_dad54c._.js.map