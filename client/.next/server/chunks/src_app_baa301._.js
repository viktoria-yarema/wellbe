...
"[project]/src/app/(entities)/company/queries/useCompaniesListById.ts [app-ssr] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_dynamic__, p: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "useCompaniesListById": ()=>useCompaniesListById
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tanstack/react-query/build/modern/useQueries.js [app-ssr] (ecmascript)");
...
;
;
const useCompaniesListById = (ids)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueries"]({
        queries: companyQueries
    });
};

})()),
"[project]/src/app/(entities)/appointment/hooks/useFullAppointment.ts [app-ssr] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_require_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, l: __turbopack_load__, j: __turbopack_dynamic__, p: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "useFullAppointment": ()=>useFullAppointment
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$entities$292f$company$2f$queries$2f$useCompaniesListById$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/(entities)/company/queries/useCompaniesListById.ts [app-ssr] (ecmascript)");
...
;
;
const useFullAppointment = (status)=>{
    const { data: appointments = [], isLoading, isError } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$entities$292f$appointment$2f$queries$2f$useAppointments$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAppointments"]({
        status
    });
    // Early return for loading and error states
    if (isLoading || isError) {
        return []; // Or handle loading/error states appropriately
    }
    const companyIds = appointments.map((it)=>it.companyId);
    const companyResults = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$entities$292f$company$2f$queries$2f$useCompaniesListById$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCompaniesListById"](companyIds);
    const result = appointments.map((appointment, index)=>{
        const companyData = companyResults[index].data;
        return {
            ...appointment,
            companyImg: companyData?.pictureUrl,
...
//# sourceMappingURL=src_app_baa301._.js.map